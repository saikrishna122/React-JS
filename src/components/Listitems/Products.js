...
const Products = ({onAddItem,onRemoveItem}) => {
    ...
    useEffect(() => {
        async function fetchItems() {
            try {
                const response = await axios.get('https://react-guide-2023-aea0b-default-rtdb.firebaseio.com/items.json')
    ...
    const updateItemTitle = async (itemId) => {
        ...
        try {
            ...
            await axios.patch(`https://react-guide-2023-aea0b-default-rtdb.firebaseio.com//items/${itemId}.json`, {
                title: title
            })
            let data = [...items]
